...
<a href="/warga/tambahView" class="btn btn-success"> Buat Keluhan</a>
...
<?php  foreach($keluhan as $r) :?>
      ...
      ?></td>
      <td>
	   <a href="/Warga/Detail/<?=$r['id'];?>" class="btn btn-primary" style="border-radius: 25px; background-color:#ff381a; border: 1px solid #ff381a;">Detail</a>
	  </td>
